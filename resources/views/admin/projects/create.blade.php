                        ...
                        <div class="card-body " style="text-align: right">
                            <fieldset class="form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input value="{{ old('front_apartments_count', 4) }}" name="front_apartments_count"
                                        type="number" min="1" class="form-control" id="basicInput" required>
                                    <h5 class="mt-2">@lang('site.back_apartments_count')</h5>
                                    <input value="{{ old('back_apartments_count', 4) }}" name="back_apartments_count"
                                        type="number" min="1" class="form-control" id="basicInput" required>

                                    <h5 class="mt-2">@lang('site.appendix_count')</h5>
                                    <input value="{{ old('appendix_count', 0) }}" min="0" name="appendix_count"
                        ...
                        <div class="card-body " style="text-align: right">
                            ...
                            <fieldset class="form-group">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <h5 class="mt-2">@lang('site.image')</h5>
                                    <input value="{{ old('fimg') }}"  name="fimg" type="file" class="form-control" id="basicInput" required>
                        ...
                        <div class="card-body " style="text-align: right">
                            ...
                            <fieldset class="form-group">
                                ...
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <h5 class="mt-2">@lang('site.image')</h5>
                                    <input value="{{ old('bimg') }}"  name="bimg" type="file" class="form-control" id="basicInput" required>
