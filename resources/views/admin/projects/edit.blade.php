                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="category" id="" class="form-control">
                                        @foreach ($categories as $item)
                                            <option value="{{ $item->id }}" @if ($item->id ==$project->category_id)
                                                selected
                                            @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    <h5 class="mt-2">@lang('site.name')</h5>
                                    <input value="{{ old('name', $project->name) }}" name="name" type="text" class="form-control"
                                    ...
                                    <input value="{{ old('img[]') }}" name="img[]" multiple type="file" class="form-control" id="basicInput" >

                                </div>
                                <div class="col-lg-6">
                                    <h5 class="mt-2">@lang('site.floors_count')</h5>
                                    <input value="{{ old('floors_count', $project->floors_count) }}" name="floors_count" type="number"
                                        min="1" class="form-control" id="basicInput" required>

                                    <h5 class="mt-2">@lang('site.front_apartments_count')</h5>
                                    <input value="{{ old('front_apartments_count',$project->front_apartments_count) }}" name="front_apartments_count"
                                        type="number" min="1" class="form-control" id="basicInput" required>
                                    <h5 class="mt-2">@lang('site.back_apartments_count')</h5>
                                    <input value="{{ old('back_apartments_count',  $project->back_apartments_count) }}" name="back_apartments_count"
                                        type="number" min="1" class="form-control" id="basicInput" required>

                                    <h5 class="mt-2">@lang('site.appendix_count')</h5>
                                    <input value="{{ old('appendix_count',$project->appendix_count) }}" min="0" name="appendix_count"
                        ...
                        <div class="card-body " style="text-align: right">
                            ...
                            <fieldset class="form-group">
                                <div class="col-lg-6  mt-3">
                                    ...
                                    <input value="{{ old('farea',$project->front_apartment->area) }}" name="farea" type="number" min="0"
                                        class="form-control" id="basicInput" required>

                                    <h5 class="mt-2">السعر</h5>
                                    <input value="{{ old('fprice',$project->front_apartment->price) }}" name="fprice" type="number" min="0"
                                        class="form-control" id="basicInput" required>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    ...
                                    <h5 class="mt-2">@lang('site.image')</h5>
                                    <input value="{{ old('fimg') }}"  name="fimg" type="file" class="form-control" id="basicInput">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body " style="text-align: right">
                            ...
                            <fieldset class="form-group">
                                <div class="col-lg-6 mt-3">
                                    <h5 class="mt-2">المساحة</h5>
                                    <input value="{{ old('barea',$project->back_apartment->area) }}" name="barea" type="number" min="0"
                                        class="form-control" id="basicInput" required>

                                    <h5 class="mt-2">السعر</h5>
                                    <input value="{{ old('bprice',$project->back_apartment->price) }}" name="bprice" type="number" min="0"
                                        class="form-control" id="basicInput" required>
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <h5 class="mt-2"> التفاصيل</h5>
                                    ...
                                    <h5 class="mt-2">@lang('site.image')</h5>
                                    <input value="{{ old('bimg') }}"  name="bimg" type="file" class="form-control" id="basicInput">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body " style="text-align: right">
                            ...
                            <fieldset class="form-group">
                                <div class="col-lg-6 mt-3">
                                    <h5 class="mt-2">المساحة</h5>
                                    <input value="{{ old('aarea', $project->appendix_apartment->area ?? '')  }}" name="aarea" type="number" min="0"
                                        class="form-control" id="basicInput" >

                                    <h5 class="mt-2">السعر</h5>
                                    <input value="{{ old('aprice', $project->appendix_apartment->price?? '') }}" name="aprice" type="number" min="0"
                                        class="form-control" id="basicInput">
                                </div>
                                <div class="col-lg-6 mt-3">
                                    <h5 class="mt-2"> التفاصيل</h5>
                                    ...
                                    <h5 class="mt-2">@lang('site.image')</h5>
                                    <input value="{{ old('aimg') }}"  name="aimg" type="file" class="form-control" id="basicInput" >
