                            ...
                            <fieldset class="form-group">
                                <form action="{{ route('admin.apartments.check', $apartment->id) }}" method="post"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        {{-- <input value="{{ old('floor') }}" name="floor" type="number" min="1"
                                    ...
                                    <div class="col-lg-6">
                                       ...
                                       color: white;
                                       font-weight: bolder;
                                       font-size: 16px; background-color: gold"> متاح</td>
                                                <td
                                                style="text-align: center;
                                       color: white;
                                       font-weight: bolder;
                                       font-size: 16px; background-color: rgb(51, 233, 111)"> محجوز</td>
                                                <td
                                                style="text-align: center;
                                       color: white;
                                       font-weight: bolder;
                                       font-size: 16px; background-color: #004848"> مباع</td>
                                            </tr>
